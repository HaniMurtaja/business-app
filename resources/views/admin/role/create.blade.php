...
@section('title') {{ucwords(__('cp.roleTitle'))}}
@endsection
@section('css')
@endsection
@section('content')
                                ...
                                @foreach($locales as $locale)
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="name_{{$locale->lang}}">
                                            {{__('cp.Roletitle_'.$locale->lang)}}
                                            <span class="symbol">*</span>
                                        </label>
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="name_{{$locale->lang}}"
                                                   placeholder="  {{__('cp.Roletitle_'.$locale->lang)}}"
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    ...
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a href="{{url(getLocal().'/admin/role')}}" class="btn default">{{__('cp.cancel')}}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
