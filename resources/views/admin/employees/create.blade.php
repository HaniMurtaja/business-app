        ...
        <!--</div>-->
            ...
            <div class="form-group">
                 ...
                 <div class="form-group" id="salary_type">
                    ...
                    <div class="col-md-6 input-field">
                        <select class="form-control select02" name="salary_type">
                            <option value="fixed"> {{__('cp.fixed')}} </option>
                            <option value="percentage"> {{__('cp.percentage')}} </option>
                        </select>
                    </div>
                </div> 
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="number" class="form-control" name="salary_amount" value="{{old('salary_amount')}}" id="salary_amount">
                    </div>
                </div>
