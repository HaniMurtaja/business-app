        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    ...
                    <fieldset style="padding: 10px; border-bottom: 1px dotted #ccc;">
                        <div class="form-group">
                            <label class="col-sm-3 control-label"> {{__('cp.deserved_amount')}} </label>
                            <div class="col-md-9 bold"> {{ @$item->deserved_amount }} </div>
                        </div>
                    </fieldset>        
                    ...
                    <fieldset style="padding: 10px; border-bottom: 1px dotted #ccc;">
                        <div class="form-group">
                            <label class="col-sm-3 control-label"> {{__('cp.salary_type')}} </label>
                            <div class="col-md-9 bold"> {{ __('cp.' . $item->salary_type) }} </div>
                        </div>
                    </fieldset>
                    ...
                    <fieldset style="padding: 10px; border-bottom: 1px dotted #ccc;">
                        <div class="form-group">
                            <label class="col-sm-3 control-label"> {{__('cp.salary_amount')}} </label>
                            <div class="col-md-9 bold"> {{ @$item->salary_amount }} </div>
                        </div>
                    </fieldset>
