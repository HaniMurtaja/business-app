        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                ...
                <div class="box-filter-collapse">
                    <form class="form-horizontal" method="get" action="{{url(getLocal().'/admin/chats')}}">
                        <div class="row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            <input type="date" class="form-control pull-right" value="{{request('from_date')?request('from_date'):''}}" name="from_date" id="from_date">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            <input type="date" class="form-control pull-right" value="{{request('to_date')?request('to_date'):''}}" name="to_date" id="to_date">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a href="{{url('admin/chats')}}" type="submit" class="btn sbold btn-default">
                                           {{__('cp.reset')}}
                    ...
                    <tr class="odd gradeX" id="tr-{{$item->id}}">
                        ...
                        <td>
                            <div class="btn-group btn-action">
                                ...
                                <a href="{{url(getLocal().'/admin/chats/'.$item->id)}}"  class="btn btn-xs blue tooltips">
                                    <i class="fa fa-eye"></i>
                                </a>                                                    
...
@section('script')
    <script>
         ...
         function delete_adv(id,iss_id, e) {
            ...
            console.log(id);
            console.log(iss_id);
                    var url = '{{url(getLocal()."/admin/chats")}}/' + id;
