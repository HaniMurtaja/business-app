                ...
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{url(app()->getLocale().'/admin/admins/create')}}" style="margin-right: 5px" class="btn btn-primary">
                                {{ __('cp.add') }} 
                             ...
                             <button class="btn btn-danger event" data-action="active" href="#activation" role="button" data-toggle="modal">
                                 {{ __('cp.active') }}
                                 <i class="fa fa-check"></i>
                             </button>
 
                             <button class="btn btn-danger event"href="#cancel_activation" role="button" data-toggle="modal" data-action="not_active">
                                 {{ __('cp.not_active') }}
                                 <i class="fa fa-minus"></i>
                             </button>
 
                             <button class="btn btn-warning event" href="#deleteAll" role="button" data-toggle="modal">
                                 {{__('cp.delete')}}
                        ...
                        <td>
                            ...
                            <div class="btn-group btn-action">
                                ...
                                <a href="{{url(getLocal().'/admin/admins/'.$item->id.'/edit_password')}}"
                                   class="btn btn-xs tooltips" data-container="body" data-placement="top"
                                   data-original-title="{{__('cp.edit_password')}}">
                                   <img src="{{ url('uploads/icons/lock.png') }}">
                                </a>
