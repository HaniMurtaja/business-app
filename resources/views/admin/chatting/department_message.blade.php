...
@section('content')
    ...
    <h4>
        {{ __('cp.chatWith'). ": ". $chat->manager->name}}
    </h4>
    ...
    <div class="portlet light bordered">
        ...
        {{$chatter->message}}
                                ...
                                <form class="form-horizontal" method="post" action="{{url(app()->getLocale().'/admin/department_new_message')}}" enctype="multipart/form-data">
                                    {{csrf_field()}}
