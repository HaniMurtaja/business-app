    ...
    <div class="portlet light bordered">
                            ...
                            <div class="col-md-8 col-md-offset-2" style="background: #f1f1f1;padding: 30px 0;">
                                @if($all_chat_this_user)
                                    ...
                                    @foreach($all_chat_this_user as $chatter)
                                        ...
                                        @if($chatter and $chatter->sender_id == 0)
                                            ...
                                            <div class="col-md-12 text-left" style="margin-bottom: 20px;">
                                                <div style="margin-bottom: 10px;">
                                                    ...
                                                    @if($chatter->chat->category_id == null)
                                                        <img src="{{ $setting->logo }}" class="user-image" style="max-height: 30px;">
                                                        {{ $setting->title }}
                                                        @else
                                                            <img src="{{ $chatter->chat->category->image }}" class="user-image" style="max-height: 30px;">
                                                            <strong> {{ $chatter->chat->category->name }} </strong>
                                                    @endif
                                                ...
                                                <span style="background-color: #b2b9bb;padding: 5px; margin-top: 5px; color: #fff;border-radius: 5px !important;"
        ...
        {{$chatter->message}}
                                ...
                                <form class="form-horizontal" method="post"
                                      action="{{url(app()->getLocale().'/admin/new_message')}}"
                                      enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    
                                    
                                    <input type="hidden" name="user_id" value="{{$chat->user1}}">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="pw" name="response" value="" class="form-control"
                                                   required="" placeholder="{{__('cp.write_msg')}}">
                                        </div>
