        ...
        <div class="row">
            <div class="col-sm-9">
                <div class="btn-group">
                    ...
                    <a href="{{ route('admin.companies.create') }}" style="margin-right: 5px"
            ...
            <tr class="odd gradeX" id="tr-{{$item->id}}">
                ...
                <td class="p-0">
                    <div class="btn-group btn-action">
                        ...
                        <a data-id="{{$item->id}}" data-toggle="tooltip" data-container="body"
                           data-placement="top" data-original-title="{{__('cp.delete')}}"
