...
@section('content')
    ...
    <form method="post" action="{{ route('admin.companies.update',$item->id) }}" enctype="multipart/form-data"
        ...
        <div class="form-group">
            <label class="col-sm-3 control-label" for="phone">
                {{__('cp.phone')}} <span class="symbol">*</span>
            </label>
            <div class="col-md-6">
                <input type="text" class="form-control" name="phone" id="phone" value="{{ old('phone', $item->phone) }}">
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-md-6 col-md-offset-3">
                <div class="fileinput-new thumbnail"
                    ...
                    <img src="{{url($item->image_profile)}}" id="editImage" style="max-width:100px;">
                </div>
                <div class="btn red"
                     onclick="document.getElementById('edit_image').click()">
        ...
        <div class="form-actions" style="margin-top: 10px;">
            <div class="row">
                <div class="col-md-offset-3 col-md-9">
                    ...
                    <a href="{{ route('admin.companies.index') }}" class="btn btn-warning">{{__('cp.cancel')}}</a>
                </div>
            </div>
        </div>
