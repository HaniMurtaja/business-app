...
<body>
    ...
    {{-- {!! QrCode::size(250)->generate('ItSolut4234234ionStuff.com'); !!} --}}
   ...
   <div class="pricing-tabel text-center">
    ...
    <section class="latest spad">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item hvr-grow">
                        <div class="blog__item__pic set-bg" data-setbg="{{ url('sitefolder/img/card1.jpg') }}">
                            <ul class="product__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                            </ul>
                        </div>
                        <div class="blog__item__text">
                            <span><img src="{{ url('sitefolder/img/icon/calendar.png') }}" alt=""> 16 February 2020</span>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item hvr-grow">
                        <div class="blog__item__pic set-bg" data-setbg="{{ url('sitefolder/img/card2.jpg') }}">
                            <ul class="product__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                            </ul>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item hvr-grow">
                        <div class="blog__item__pic set-bg" data-setbg="{{ url('sitefolder/img/card3.jpg') }}">
                            <ul class="product__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                            </ul>
                        </div>
            ...
            <div class="_11 text-center">
                <a href="./blog.html" class="primary-btn hvr-pulse-grow hvr-icon-wobble-horizontal text-center">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="instagram__pic">
                        ...
                        <div class="instagram__pic__item set-bg hvr-grow" data-setbg="{{ url('sitefolder/img/vistor2.jpg') }}"></div>
                        <div class="instagram__pic__item set-bg hvr-grow" data-setbg="{{ url('sitefolder/img/vistor3.jpg') }}"></div>
                        <div class="instagram__pic__item set-bg hvr-grow" data-setbg="{{ url('sitefolder/img/card1.jpg') }}"></div>
                        <div class="instagram__pic__item set-bg hvr-grow" data-setbg="{{ url('sitefolder/img/card2.jpg') }}"></div>
                        <div class="instagram__pic__item set-bg hvr-grow" data-setbg="{{ url('sitefolder/img/card3.jpg') }}"></div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="instagram__text">
                        ...
                        <a href="./gallry.html" class="primary-btn hvr-grow-shadow">Show more</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="recentNews">
        <div class="container">
            ...
            <div class="owl-carousel owl-theme blog-carousal">
                <div class="item">  <div class="ct-blog">
                    <div class="inner">
                        <div class="fauxcrop">
                            <a href="#"><img alt="News Entry" class="hvr-grow" src="{{ url('sitefolder/img/card1.jpg') }}"></a>
                        </div>
            ...
            <div class="item">  <div class="ct-blog">
                <div class="inner">
                    <div class="fauxcrop">
                        <a href="#"><img alt="News Entry" class="hvr-grow" src="{{ url('sitefolder/img/card2.jpg') }}"></a>
                    </div>
        ...
        <div class="item">  <div class="ct-blog">
            <div class="inner">
                <div class="fauxcrop">
                    <a href="#"><img alt="News Entry" class="hvr-grow" src="{{ url('sitefolder/img/card3.jpg') }}"></a>
                </div>
                <div class="ct-blog-content">
                    <div class="ct-blog-date">
                        <span>March</span><strong>1</strong>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel owl-theme company_carousal owl-loaded owl-drag ">
                        <div class="item"><img src="{{ url('sitefolder/img/1 .png') }}" alt=""></div>
                        <div class="item"><img src="{{ url('sitefolder/img/3 .png') }}" alt=""></div>
                        <div class="item"><img src="{{ url('sitefolder/img/1 .png') }}" alt=""></div>
                        <div class="item"><img src="{{ url('sitefolder/img/3 .png') }}" alt=""></div>
                        <div class="item"><img src="{{ url('sitefolder/img/1 .png') }}" alt=""></div>
                        <div class="item"><img src="{{ url('sitefolder/img/3 .png') }}" alt=""></div>
