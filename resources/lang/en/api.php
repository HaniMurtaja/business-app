...
return [
    ...
    'couponError' => 'Coupon error, Please enter true coupon', 
    
    'youCanUseItOnce' => 'You can only use the coupon once',

    'pleaseEnterTrueEmail' => 'Please Enter True Mobile Number',
    'youHaveNewOrder' => 'You have new order',
    
    'YourActivationCodeIs' => 'Your activation code is',
    'YourNewPasswordIs' => 'Your new password is',
    
    'youCantReserveThisLocation' => 'You can\'t reserve this location', 
    
    'productNotFound' => 'This Product Not Found',
    
    'deleteFromCart' => 'The Product Deleted From Cart',
    ...
    'pleaseEnterTrueOldMobileNumber' => 'Please enter true old mobile number',
    
    'store_accept_your_order' => 'Store accept your order',
    
    'store_reject_your_order' => 'Store reject your order',
    
    'yourAccountNotActive' => 'Your account not active',
    
    'youDontHavePermession' => 'You don\'t have permession',

    'addedToCart' => 'Successfully added to the cart',
    
    'wrongLogin' => 'Please Enter True Mobile Number and Password',
    
    'wrongMobile' => 'Please enter true mobile number',
    
    'new_password_sent' => 'New password sent to you',
    
    'validation_code_sent' => 'Validation code sent',
    
    'not_valid_code' => 'Please enter true validation code',
    ...
    'YouCantBuyThis' => 'You can\'t buy this',
