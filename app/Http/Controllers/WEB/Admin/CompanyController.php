...
class CompanyController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $items = $items->where('type', 'company')->latest()->paginate($this->settings->rows_pagination_count);
        return view('admin.companies.home', ['items' => $items]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $item->save();
        return redirect()->route('admin.companies.index')->with('status', __('cp.create'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.companies.edit',['item' => $item]);
    }
    ...
    {
        $item = User::findOrFail($id);
        return view('admin.companies.show',['item' => $item]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.companies.index')->with('status', __('cp.update'));
    }
